                        ...
                        <form method="POST" action=@yield('form-action')>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 d-flex justify-content-center">
                                    <div>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a role="button" class="btn btn-warning rounded-circle py-2 px-3 mx-1">6</a>
                                ...
                                <div class="col-md-3 text-right">
                                    ...
                                    <a class="btn btn-primary btn-lg" href="{{route('student.csa-form.csa-page7')}}" role="button" id="next_btn">@yield('next-value')</a>
                                </div>
                            </div>
                        </form>
                        </div>
