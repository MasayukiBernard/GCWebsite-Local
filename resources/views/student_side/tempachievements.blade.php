    ...
    <div class="row justify-content-center">
      <div class="col-md-12 w-auto">
        <h3 class="font-weight-bold">Your Achievements</h3>
         <div class="row pt-4">
          <div class="col-md-1">
          <a class="font-weight-bold">{{ __('No') }}</a>
          </div>
          <div class="col-md-3">
          <a class="font-weight-bold">{{ __('Achievement') }}</a>
          </div>
          <div class="col-md-1">
          <a class="font-weight-bold">{{ __('Year') }}</a>
          </div>
          <div class="col-md-2">
          <a class="font-weight-bold">{{ __('Institution') }}</a>
          </div>
          <div class="col-md-2">
          <a class="font-weight-bold">{{ __('Detail') }}</a>
          </div>
          <div class="col-md-3">
          <a class="font-weight-bold">{{ __('Proof Document') }}</a>
          </div>
         </div>
